...
# Source0-md5:	3e978ab7533c3adb54cd57435b2a38d3
...
Summary(pl.UTF-8):      Biblioteka dodaj�~Eca obs�~Bug�~Y protoko�~Bu OTR
Group:          X11/Applications/Networking
Requires:       %{name}-libkopete = %{version}-%{release}
...
Biblioteka dodaj�~Eca obs�~Bug�~Y protoko�~Bu OTR, używanego mi�~Ydzy
innymi przez AIM i ICQ.
